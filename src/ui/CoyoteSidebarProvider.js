...
<option value="slowPulse">缓慢脉冲</option>
<option value="triangle">三角波</option>
<option value="staircase">阶梯变化</option>
<option value="alternatingIntensity">强度交替</option>
<option value="frequencyPulse">频率脉冲</option>
<option value="sweepBack">往返扫频</option>
<option value="doubleWave">双峰波</option>
<option value="randomStep">随机阶跃</option>
<option value="alternatingFrequency">频率交替</option>
<option value="crescendo">渐强</option>
<option value="decrescendo">渐弱</option>
<option value="heartbeat">节奏脉冲</option>
<option value="chaotic">不规则变化</option>
</select>
</div>
